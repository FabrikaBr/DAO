...
var sdkCommon = require('@aragon/sdk-common');
...
})(exports.DaoSortBy || (exports.DaoSortBy = {}));
(function (PluginSortBy) {
  PluginSortBy["SUBDOMAIN"] = "subdomain";
})(exports.PluginSortBy || (exports.PluginSortBy = {}));
...
})(exports.DaoDepositSteps || (exports.DaoDepositSteps = {}));
(function (AssetBalanceSortBy) {
  AssetBalanceSortBy["LAST_UPDATED"] = "lastUpdated";
})(exports.AssetBalanceSortBy || (exports.AssetBalanceSortBy = {}));
...
})(exports.TransferSortBy || (exports.TransferSortBy = {}));
...
})(exports.SetAllowanceSteps || (exports.SetAllowanceSteps = {}));
...
var SubgraphTransferTypeMap = /*#__PURE__*/new Map([[exports.TransferType.DEPOSIT, SubgraphTransferType.DEPOSIT], [exports.TransferType.WITHDRAW, SubgraphTransferType.WITHDRAW]]);
...
var SupportedNetworksArray = /*#__PURE__*/Object.values(exports.SupportedNetwork);
(function (DaoRole) {
...
})(exports.DaoRole || (exports.DaoRole = {}));
...
var Web3Module = /*#__PURE__*/function () {
  ...
  _proto.shiftProvider = function shiftProvider() {
    if (!this.context.web3Providers.length) {
      throw new sdkCommon.NoProviderError();
    } else if (this.context.web3Providers.length <= 1) {
      throw new sdkCommon.NoNodesAvailableError("web3");
    }
  ...
  _proto.getSigner = function getSigner() {
    if (!this.context.signer) {
      throw new sdkCommon.NoSignerError();
    }
  ...
  _proto.getNetworkName = function getNetworkName() {
    ...
    if (!SupportedNetworksArray.includes(networkName)) {
      throw new sdkCommon.UnsupportedNetworkError(networkName);
    }
    return networkName;
  }
  ...
  _proto.attachContract = function attachContract(address$1, abi) {
    if (!address$1 || !address.isAddress(address$1)) throw new sdkCommon.InvalidAddressError();else if (!abi) throw new sdkCommon.InvalidContractAbiError();
  ...
  _proto.getMaxFeePerGas = function getMaxFeePerGas() {
    return this.getConnectedSigner().getFeeData().then(function (feeData) {
      if (!feeData.maxFeePerGas) {
        throw new sdkCommon.CannotEstimateGasError();
      }
  ...
  _proto.getDaoFactoryAddress = function getDaoFactoryAddress() {
    if (!this.context.daoFactoryAddress) {
      throw new sdkCommon.NoDaoFactory();
    }
...
var IPFSModule = /*#__PURE__*/function () {
  ...
  _proto.getClient = function getClient() {
    if (!this.clients.length || !this.clients[this.clientIdx]) {
      throw new sdkCommon.ClientNotInitializedError("ipfs");
    }
  ...
  _proto.shiftClient = function shiftClient() {
    ...
    if (!this.clients.length) {
      ...
      throw new sdkCommon.NoNodesAvailableError("ipfs");
    }
      ...
      onFail: function onFail(e) {
        if (e instanceof sdkIpfs.ClientError) {
          if (e.response.status < 500) {
            ...
            throw new sdkCommon.IpfsError(e);
          }
        }
        retries--;
        _this5.shiftClient();
  ...
  _proto.fetchString = function fetchString(cid) {
    return this.fetchBytes(cid).then(function (bytes) {
      ...
      throw new sdkCommon.DataDecodingError(e.message);
    });
  };
  return IPFSModule;
}();
...
var QueryStatus = /*#__PURE__*/graphqlRequest.gql(_templateObject$4 || (_templateObject$4 = /*#__PURE__*/_taggedTemplateLiteralLoose(["\n{\n  _meta{\n    deployment\n  }\n}\n"])));
...
var GraphqlModule = /*#__PURE__*/function () {
  ...
  _proto.getClient = function getClient() {
    if (!this.clients.length || !this.clients[this.clientIdx]) {
      throw new sdkCommon.ClientNotInitializedError("graphql");
    }
    return this.clients[this.clientIdx];
  }
  /**
  ...
  _proto.shiftClient = function shiftClient() {
    if (!this.clients.length) {
      ...
      throw new sdkCommon.NoNodesAvailableError("graphql");
    }
    this.clientIdx = (this.clientIdx + 1) % this.clients.length;
  }
  /**
    ...
    return sdkCommon.runAndRetry({
      ...
      onFail: function onFail(e) {
        if (e instanceof graphqlRequest.ClientError) {
          ...
          // error is not generated by the server
          if (e.response.status < 500) {
            throw new sdkCommon.GraphQLError(name || "", e);
          }
        }
        retries--;
        _this.shiftClient();
...
var SupportedNetworksToGraphqlNetworks = (_SupportedNetworksToG = {}, _SupportedNetworksToG[exports.SupportedNetwork.MAINNET] = "mainnet", _SupportedNetworksToG[exports.SupportedNetwork.GOERLI] = "goerli", _SupportedNetworksToG[exports.SupportedNetwork.POLYGON] = "polygon", _SupportedNetworksToG[exports.SupportedNetwork.MUMBAI] = "mumbai", _SupportedNetworksToG);
var GRAPHQL_NODES = (_GRAPHQL_NODES = {}, _GRAPHQL_NODES[exports.SupportedNetwork.MAINNET] = [{
  url: /*#__PURE__*/getGraphqlNode(exports.SupportedNetwork.MAINNET)
}], _GRAPHQL_NODES[exports.SupportedNetwork.GOERLI] = [{
  url: /*#__PURE__*/getGraphqlNode(exports.SupportedNetwork.GOERLI)
}], _GRAPHQL_NODES[exports.SupportedNetwork.POLYGON] = [{
  url: /*#__PURE__*/getGraphqlNode(exports.SupportedNetwork.POLYGON)
}], _GRAPHQL_NODES[exports.SupportedNetwork.MUMBAI] = [{
  url: /*#__PURE__*/getGraphqlNode(exports.SupportedNetwork.MUMBAI)
}], _GRAPHQL_NODES);
var IPFS_ENDPOINTS = {
  prod: [{
...
var IPFS_NODES = (_IPFS_NODES = {}, _IPFS_NODES[exports.SupportedNetwork.MAINNET] = IPFS_ENDPOINTS.prod, _IPFS_NODES[exports.SupportedNetwork.GOERLI] = IPFS_ENDPOINTS.test, _IPFS_NODES[exports.SupportedNetwork.POLYGON] = IPFS_ENDPOINTS.prod, _IPFS_NODES[exports.SupportedNetwork.MUMBAI] = IPFS_ENDPOINTS.test, _IPFS_NODES);
var LIVE_CONTRACTS = (_LIVE_CONTRACTS = {}, _LIVE_CONTRACTS[exports.SupportedNetwork.MAINNET] = {
  daoFactory: osxEthers.activeContractsList.mainnet.DAOFactory,
  pluginSetupProcessor: osxEthers.activeContractsList.mainnet.PluginRepoFactory,
  multisigRepo: osxEthers.activeContractsList.mainnet["multisig-repo"],
  adminRepo: osxEthers.activeContractsList.mainnet["admin-repo"],
  addresslistVotingRepo: osxEthers.activeContractsList.mainnet["address-list-voting-repo"],
  tokenVotingRepo: osxEthers.activeContractsList.mainnet["token-voting-repo"],
  multisigSetup: osxEthers.activeContractsList.mainnet.MultisigSetup,
  adminSetup: osxEthers.activeContractsList.mainnet.AdminSetup,
  addresslistVotingSetup: osxEthers.activeContractsList.mainnet.AddresslistVotingSetup,
  tokenVotingSetup: osxEthers.activeContractsList.mainnet.TokenVotingSetup
}, _LIVE_CONTRACTS[exports.SupportedNetwork.GOERLI] = {
  daoFactory: osxEthers.activeContractsList.goerli.DAOFactory,
  pluginSetupProcessor: osxEthers.activeContractsList.goerli.PluginSetupProcessor,
  multisigRepo: osxEthers.activeContractsList.goerli["multisig-repo"],
  adminRepo: osxEthers.activeContractsList.goerli["admin-repo"],
  addresslistVotingRepo: osxEthers.activeContractsList.goerli["address-list-voting-repo"],
  tokenVotingRepo: osxEthers.activeContractsList.goerli["token-voting-repo"],
  multisigSetup: osxEthers.activeContractsList.goerli.MultisigSetup,
  adminSetup: osxEthers.activeContractsList.goerli.AdminSetup,
  addresslistVotingSetup: osxEthers.activeContractsList.goerli.AddresslistVotingSetup,
  tokenVotingSetup: osxEthers.activeContractsList.goerli.TokenVotingSetup
}, _LIVE_CONTRACTS[exports.SupportedNetwork.MUMBAI] = {
  daoFactory: osxEthers.activeContractsList.mumbai.DAOFactory,
  pluginSetupProcessor: osxEthers.activeContractsList.mumbai.PluginSetupProcessor,
  multisigRepo: osxEthers.activeContractsList.mumbai["multisig-repo"],
  adminRepo: osxEthers.activeContractsList.mumbai["admin-repo"],
  addresslistVotingRepo: osxEthers.activeContractsList.mumbai["address-list-voting-repo"],
  tokenVotingRepo: osxEthers.activeContractsList.mumbai["token-voting-repo"],
  multisigSetup: osxEthers.activeContractsList.mumbai.MultisigSetup,
  adminSetup: osxEthers.activeContractsList.mumbai.AdminSetup,
  addresslistVotingSetup: osxEthers.activeContractsList.mumbai.AddresslistVotingSetup,
  tokenVotingSetup: osxEthers.activeContractsList.mumbai.TokenVotingSetup,
  ensRegistry: osxEthers.activeContractsList.mumbai.ENSRegistry
}, _LIVE_CONTRACTS[exports.SupportedNetwork.POLYGON] = {
  daoFactory: osxEthers.activeContractsList.polygon.DAOFactory,
  pluginSetupProcessor: osxEthers.activeContractsList.polygon.PluginSetupProcessor,
  multisigRepo: osxEthers.activeContractsList.polygon["multisig-repo"],
  adminRepo: osxEthers.activeContractsList.polygon["admin-repo"],
  addresslistVotingRepo: osxEthers.activeContractsList.polygon["address-list-voting-repo"],
  tokenVotingRepo: osxEthers.activeContractsList.polygon["token-voting-repo"],
  multisigSetup: osxEthers.activeContractsList.polygon.MultisigSetup,
  adminSetup: osxEthers.activeContractsList.polygon.AdminSetup,
  addresslistVotingSetup: osxEthers.activeContractsList.polygon.AddresslistVotingSetup,
  tokenVotingSetup: osxEthers.activeContractsList.polygon.TokenVotingSetup,
  ensRegistry: osxEthers.activeContractsList.polygon.ENSRegistry
}, _LIVE_CONTRACTS);
...
var Context = /*#__PURE__*/function () {
  ...
  Context.resolveNetwork = function resolveNetwork(networkish, ensRegistryAddress) {
    var network = providers.getNetwork(networkish);
    ...
    if (ensRegistryAddress) {
      if (!address.isAddress(ensRegistryAddress)) {
        throw new sdkCommon.InvalidAddressError();
      } else {
      ...
      return endpoints.map(function (item) {
        if (typeof item === "string") {
          ...
          if (!supportedProtocols.includes(url.protocol)) {
            throw new sdkCommon.UnsupportedProtocolError(url.protocol);
          }
...
function unwrapProposalParams(params) {
  ...
  // TODO: Verify => seconds?
  params.endDate ? Math.floor(params.endDate.getTime() / 1000) : 0, (_params$executeOnPass = params.executeOnPass) != null ? _params$executeOnPass : false, (_params$creatorVote = params.creatorVote) != null ? _params$creatorVote : exports.VoteValues.ABSTAIN];
}
function computeProposalStatus(proposal) {
  ...
  if (proposal.executed) {
    return exports.ProposalStatus.EXECUTED;
  }
  if (startDate >= now) {
    return exports.ProposalStatus.PENDING;
  }
  if (proposal.potentiallyExecutable || proposal.earlyExecutable) {
    return exports.ProposalStatus.SUCCEEDED;
  }
  if (endDate >= now) {
    return exports.ProposalStatus.ACTIVE;
  }
  return exports.ProposalStatus.DEFEATED;
}
function computeProposalStatusFilter(status) {
  var where = {};
  var now = Math.round(new Date().getTime() / 1000).toString();
  switch (status) {
    case exports.ProposalStatus.PENDING:
      where = {
        startDate_gte: now
      };
      break;
    case exports.ProposalStatus.ACTIVE:
      where = {
        startDate_lt: now,
        endDate_gte: now,
        executed: false
      ...
      break;
    case exports.ProposalStatus.EXECUTED:
      where = {
        executed: true
      };
      break;
    case exports.ProposalStatus.SUCCEEDED:
      where = {
        potentiallyExecutable: true,
        endDate_lt: now
      };
      break;
    case exports.ProposalStatus.DEFEATED:
      where = {
...
function votingModeToContracts(votingMode) {
  switch (votingMode) {
    case exports.VotingMode.STANDARD:
      return 0;
    case exports.VotingMode.EARLY_EXECUTION:
      return 1;
    case exports.VotingMode.VOTE_REPLACEMENT:
      return 2;
    default:
      throw new sdkCommon.InvalidVotingModeError();
  }
}
function votingModeFromContracts(votingMode) {
  switch (votingMode) {
    case 0:
      return exports.VotingMode.STANDARD;
    case 1:
      return exports.VotingMode.EARLY_EXECUTION;
    case 2:
      return exports.VotingMode.VOTE_REPLACEMENT;
    default:
      throw new sdkCommon.InvalidVotingModeError();
  }
}
...
function decodeUpdatePluginSettingsAction(data) {
  var votingInterface = osxEthers.MajorityVotingBase__factory.createInterface();
  var hexBytes = sdkCommon.bytesToHex(data);
...
function encodeUpdateVotingSettingsAction(params) {
  ...
  return sdkCommon.hexToBytes(hexBytes);
}
function pluginSettingsFromContract(result) {
  return {
    votingMode: votingModeFromContracts(result[0][0]),
    supportThreshold: sdkCommon.decodeRatio(result[0][1], 6),
    minParticipation: sdkCommon.decodeRatio(result[0][2], 6),
...
function votingSettingsToContract(params) {
  return {
    votingMode: bignumber.BigNumber.from(votingModeToContracts(params.votingMode || exports.VotingMode.STANDARD)),
    supportThreshold: sdkCommon.encodeRatio(params.supportThreshold, 6),
    minParticipation: sdkCommon.encodeRatio(params.minParticipation, 6),
    minDuration: bignumber.BigNumber.from(params.minDuration),
    minProposerVotingPower: bignumber.BigNumber.from(params.minProposerVotingPower || 0)
  };
}
...
function unwrapDepositParams(params) {
  ...
  return [params.daoAddressOrEns, params.amount, (_params$tokenAddress = params == null ? void 0 : params.tokenAddress) != null ? _params$tokenAddress : constants.AddressZero, ""];
}
...
function toAssetBalance(balance) {
  ...
  if (balance.__typename === "NativeBalance") {
    return {
      type: exports.TokenType.NATIVE,
      balance: BigInt(balance.balance),
      updateDate: updateDate
    };
  } else if (balance.__typename === "ERC721Balance") {
    return {
      type: exports.TokenType.ERC721,
...
function toTokenTransfer(transfer) {
  ...
  if (transfer.__typename === "NativeTransfer") {
    ...
    if (transfer.type === SubgraphTransferType.DEPOSIT) {
      return {
        type: exports.TransferType.DEPOSIT,
        tokenType: exports.TokenType.NATIVE,
    ...
    return {
      type: exports.TransferType.WITHDRAW,
      tokenType: exports.TokenType.NATIVE,
      amount: BigInt(transfer.amount),
      creationDate: creationDate,
      transactionId: transfer.txHash,
...
function applyInstallatonParamsToContract(params) {
  return {
    ...
    helpersHash: keccak256.keccak256(abi.defaultAbiCoder.encode(["address[]"], [params.helpers])),
    permissions: params.permissions.map(function (permission) {
      return _extends({}, permission, {
        condition: permission.condition || constants.AddressZero
      });
    })
  };
}
...
function permissionParamsToContract(params) {
  return [params.where, params.who, keccak256.keccak256(strings.toUtf8Bytes(params.permission))];
}
...
function withdrawParamsFromContract(to, _value, result, tokenStandard) {
  if (tokenStandard === exports.TokenType.ERC20) {
    return {
      type: exports.TokenType.ERC20,
      tokenAddress: to,
...
var AVAILABLE_FUNCTION_SIGNATURES = [/*#__PURE__*/new contracts.Contract(constants.AddressZero, erc20ContractAbi)["interface"].getFunction("transfer").format("minimal"), /*#__PURE__*/osxEthers.DAO__factory.createInterface().getFunction("grant").format("minimal"), /*#__PURE__*/osxEthers.DAO__factory.createInterface().getFunction("grantWithCondition").format("minimal"), /*#__PURE__*/osxEthers.DAO__factory.createInterface().getFunction("revoke").format("minimal"), /*#__PURE__*/osxEthers.DAO__factory.createInterface().getFunction("setMetadata").format("minimal"), /*#__PURE__*/osxEthers.DAO__factory.createInterface().getFunction("setDaoURI").format("minimal"), /*#__PURE__*/osxEthers.DAO__factory.createInterface().getFunction("registerStandardCallback").format("minimal"), /*#__PURE__*/osxEthers.DAO__factory.createInterface().getFunction("setSignatureValidator").format("minimal"), /*#__PURE__*/osxEthers.DAO__factory.createInterface().getFunction("upgradeTo").format("minimal"), /*#__PURE__*/osxEthers.DAO__factory.createInterface().getFunction("upgradeToAndCall").format("minimal")];
...
var ClientMethods = /*#__PURE__*/function (_ClientCore) {
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            ...
            throw new sdkCommon.InvalidEnsError();
          case 3:
            daoFactoryInstance = osxEthers.DAOFactory__factory.connect(_this.web3.getDaoFactoryAddress(), signer);
          ...
          case 6:
            ...
            plugin = _step.value;
            repo = osxEthers.PluginRepo__factory.connect(plugin.id, signer);
            _context.next = 11;
          ...
          case 20:
            ...
            pluginSetupProcessor = osxEthers.PluginSetupProcessor__factory.connect(pluginSetupProcessorAddr, signer);
          ...
          case 39:
            ...
            throw new sdkCommon.MissingExecPermissionError();
          case 41:
            _context.next = 43;
            return _awaitAsyncGenerator(daoFactoryInstance.connect(signer).createDao({
              subdomain: params.ensSubdomain,
              metadata: strings.toUtf8Bytes(params.metadataUri),
              daoURI: params.daoUri || "",
              trustedForwarder: params.trustedForwarder || constants.AddressZero
            }, pluginInstallationData));
          case 43:
            tx = _context.sent;
            _context.next = 46;
            return {
              key: exports.DaoCreationSteps.CREATING,
              txHash: tx.hash
            };
          case 46:
            _context.next = 48;
          ...
          case 48:
            ...
            daoFactoryInterface = osxEthers.DAORegistry__factory.createInterface(); // find dao address using the dao registry address
            log = (_receipt$logs = receipt.logs) == null ? void 0 : _receipt$logs.find(function (e) {
              return e.topics[0] === hash.id(daoFactoryInterface.getEvent("DAORegistered").format("sighash"));
            });
            if (log) {
              _context.next = 53;
              break;
          ...
          case 53:
            // Plugin logs
            pspInterface = osxEthers.PluginSetupProcessor__factory.createInterface();
            installedLogs = (_receipt$logs2 = receipt.logs) == null ? void 0 : _receipt$logs2.filter(function (e) {
              return e.topics[0] === hash.id(pspInterface.getEvent("InstallationApplied").format("sighash"));
            }); // DAO logs
          ...
          case 58:
            _context.next = 60;
            return {
              key: exports.DaoCreationSteps.DONE,
      ...
      return _regeneratorRuntime().wrap(function _callee2$(_context2) {
        while (1) switch (_context2.prev = _context2.next) {
          ...
          case 9:
            ...
            throw new sdkCommon.IpfsPinError(_context2.t0);
          case 12:
          case "end":
            return _context2.stop();
        }
      ...
      return _regeneratorRuntime().wrap(function _callee3$(_context3) {
        while (1) switch (_context3.prev = _context3.next) {
          case 0:
            ...
            if (!(params.type !== exports.TokenType.NATIVE && params.type !== exports.TokenType.ERC20)) {
              _context3.next = 3;
              break;
            }
          ...
          case 3:
            ...
            tokenInstance = new contracts.Contract(tokenAddress, erc20ContractAbi, signer);
          ...
          case 15:
            ...
            _context3.next = 18;
            return {
              key: exports.DaoDepositSteps.CHECKED_ALLOWANCE,
          ...
          case 20:
            // Doing the transfer
            daoInstance = osxEthers.DAO__factory.connect(daoAddress, signer);
            override = {};
          ...
          case 25:
            ...
            _context3.next = 28;
            return {
              key: exports.DaoDepositSteps.DEPOSITING,
              txHash: tx.hash
            };
          case 28:
            _context3.next = 30;
          ...
          case 30:
            ...
            throw new sdkCommon.FailedDepositError();
          case 34:
            daoInterface = osxEthers.DAO__factory.createInterface();
            parsedLog = daoInterface.parseLog(log);
            if (!(!amount.toString() === parsedLog.args["amount"])) {
              _context3.next = 38;
              break;
            }
            throw new sdkCommon.AmountMismatchError(amount, parsedLog.args["amount"].toBigInt());
          case 38:
            _context3.next = 40;
            return {
              key: exports.DaoDepositSteps.DONE,
              amount: amount
            };
          case 40:
          case "end":
      ...
      return _regeneratorRuntime().wrap(function _callee4$(_context4) {
        while (1) switch (_context4.prev = _context4.next) {
          case 0:
            ...
            tokenInstance = new contracts.Contract(params.tokenAddress, erc20ContractAbi, signer);
            _context4.next = 4;
          ...
          case 4:
            ...
            _context4.next = 7;
            return {
              key: exports.SetAllowanceSteps.SETTING_ALLOWANCE,
              txHash: tx.hash
            };
          case 7:
            _context4.next = 9;
          ...
          case 9:
            ...
            throw new sdkCommon.UpdateAllowanceError();
          case 13:
            value = log.data;
            if (!(!value || bignumber.BigNumber.from(params.amount).gt(bignumber.BigNumber.from(value)))) {
              _context4.next = 16;
              break;
            }
            throw new sdkCommon.UpdateAllowanceError();
          case 16:
            _context4.next = 18;
            return {
              key: exports.SetAllowanceSteps.ALLOWANCE_SET,
      ...
      return _regeneratorRuntime().wrap(function _callee5$(_context5) {
        while (1) switch (_context5.prev = _context5.next) {
          ...
          case 4:
            ...
            throw new sdkCommon.InstallationNotFoundError();
          case 10:
            ...
            data = abi.defaultAbiCoder.encode(uninstallationAbi, uninstallationParams); // connect to psp contract
            pspContract = osxEthers.PluginSetupProcessor__factory.connect(LIVE_CONTRACTS[networkName].pluginSetupProcessor, signer);
            _context5.next = 15;
          ...
          case 15:
            ...
            _context5.next = 18;
            return {
              key: exports.PrepareUninstallationSteps.PREPARING,
              txHash: tx.hash
            };
          case 18:
            _context5.next = 20;
          ...
          case 20:
            ...
            throw new sdkCommon.PluginUninstallationPreparationError();
          case 24:
          ...
          case 28:
            _context5.next = 30;
            return {
              key: exports.PrepareUninstallationSteps.DONE,
      ...
      return _regeneratorRuntime().wrap(function _callee6$(_context6) {
        while (1) switch (_context6.prev = _context6.next) {
          case 0:
            ...
            daoInstance = osxEthers.DAO__factory.connect(params.daoAddressOrEns, signer);
            return _context6.abrupt("return", daoInstance.hasPermission(params.where, params.who, hash.id(params.permission), params.data || new Uint8Array([])));
          case 3:
          case "end":
  ...
  function () {
    var _getDao = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee7(daoAddressOrEns) {
      var address$1, provider, resolvedAddress, query, params, name, _yield$this$graphql$r, dao, metadataCid, metadataString, metadata;
      return _regeneratorRuntime().wrap(function _callee7$(_context7) {
        while (1) switch (_context7.prev = _context7.next) {
          case 0:
            address$1 = daoAddressOrEns;
          ...
          case 7:
            _context7.prev = 7;
            _context7.next = 10;
            return provider.resolveName(address$1);
          case 10:
            ...
            throw new sdkCommon.InvalidAddressOrEnsError();
          case 13:
            address$1 = resolvedAddress.toLowerCase();
            _context7.next = 19;
            break;
          case 16:
            _context7.prev = 16;
            _context7.t0 = _context7["catch"](7);
            throw new sdkCommon.InvalidAddressOrEnsError(_context7.t0);
          case 19:
            query = QueryDao;
            params = {
              address: address$1
          ...
          case 32:
            _context7.prev = 32;
            metadataCid = sdkCommon.resolveIpfsCid(dao.metadata);
            _context7.next = 36;
          ...
          case 41:
            ...
            if (!(_context7.t1 instanceof sdkCommon.InvalidCidError)) {
              _context7.next = 45;
              break;
            }
    ...
    var _getDaos = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee9(_ref) {
      ...
      return _regeneratorRuntime().wrap(function _callee9$(_context9) {
        while (1) switch (_context9.prev = _context9.next) {
          case 0:
            _ref$limit = _ref.limit, limit = _ref$limit === void 0 ? 10 : _ref$limit, _ref$skip = _ref.skip, skip = _ref$skip === void 0 ? 0 : _ref$skip, _ref$direction = _ref.direction, direction = _ref$direction === void 0 ? exports.SortDirection.ASC : _ref$direction, _ref$sortBy = _ref.sortBy, sortBy = _ref$sortBy === void 0 ? exports.DaoSortBy.CREATED_AT : _ref$sortBy;
            query = QueryDaos;
            params = {
              limit: limit,
              skip: skip,
                ...
                return _regeneratorRuntime().wrap(function _callee8$(_context8) {
                  while (1) switch (_context8.prev = _context8.next) {
                    ...
                    case 11:
                      ...
                      if (!(_context8.t0 instanceof sdkCommon.InvalidCidError)) {
                        _context8.next = 15;
                        break;
                      }
  ...
  function () {
    var _getDaoBalances = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee10(_ref3) {
      var daoAddressOrEns, _ref3$limit, limit, _ref3$skip, skip, _ref3$direction, direction, _ref3$sortBy, sortBy, where, address$1, provider, resolvedAddress, query, params, name, _yield$this$graphql$r3, tokenBalances;
      return _regeneratorRuntime().wrap(function _callee10$(_context10) {
        while (1) switch (_context10.prev = _context10.next) {
          case 0:
            daoAddressOrEns = _ref3.daoAddressOrEns, _ref3$limit = _ref3.limit, limit = _ref3$limit === void 0 ? 10 : _ref3$limit, _ref3$skip = _ref3.skip, skip = _ref3$skip === void 0 ? 0 : _ref3$skip, _ref3$direction = _ref3.direction, direction = _ref3$direction === void 0 ? exports.SortDirection.ASC : _ref3$direction, _ref3$sortBy = _ref3.sortBy, sortBy = _ref3$sortBy === void 0 ? exports.AssetBalanceSortBy.LAST_UPDATED : _ref3$sortBy;
            where = {};
            address$1 = daoAddressOrEns;
            if (!address$1) {
              _context10.next = 17;
          ...
          case 12:
            ...
            throw new sdkCommon.InvalidAddressOrEnsError();
          case 15:
            address$1 = resolvedAddress;
          case 16:
            where = {
              dao: address$1.toLowerCase()
            };
          case 17:
  ...
  function () {
    var _getDaoTransfers = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee11(_ref4) {
      var daoAddressOrEns, type, _ref4$limit, limit, _ref4$skip, skip, _ref4$direction, direction, _ref4$sortBy, sortBy, where, address$1, provider, resolvedAddress, query, params, name, _yield$this$graphql$r4, tokenTransfers;
      return _regeneratorRuntime().wrap(function _callee11$(_context11) {
        while (1) switch (_context11.prev = _context11.next) {
          case 0:
            daoAddressOrEns = _ref4.daoAddressOrEns, type = _ref4.type, _ref4$limit = _ref4.limit, limit = _ref4$limit === void 0 ? 10 : _ref4$limit, _ref4$skip = _ref4.skip, skip = _ref4$skip === void 0 ? 0 : _ref4$skip, _ref4$direction = _ref4.direction, direction = _ref4$direction === void 0 ? exports.SortDirection.ASC : _ref4$direction, _ref4$sortBy = _ref4.sortBy, sortBy = _ref4$sortBy === void 0 ? exports.TransferSortBy.CREATED_AT : _ref4$sortBy;
            where = {};
            address$1 = daoAddressOrEns;
            if (!address$1) {
              _context11.next = 23;
          ...
          case 19:
            ...
            throw new sdkCommon.InvalidAddressOrEnsError(_context11.t0);
          case 22:
            where = {
              dao: address$1.toLowerCase()
            };
              ...
              var _ref6 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee12(pluginRepo) {
                ...
                return _regeneratorRuntime().wrap(function _callee12$(_context12) {
                  while (1) switch (_context12.prev = _context12.next) {
                    ...
                    case 9:
                      _context12.prev = 9;
                      metadataCid = sdkCommon.resolveIpfsCid(release.metadata);
                      _context12.next = 13;
                    ...
                    case 18:
                      ...
                      if (_context12.t0 instanceof sdkCommon.InvalidCidError) {
    ...
    var _getPlugin = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee14(pluginAddress) {
      ...
      return _regeneratorRuntime().wrap(function _callee14$(_context14) {
        while (1) switch (_context14.prev = _context14.next) {
          ...
          case 10:
            _context14.prev = 10;
            metadataCid = sdkCommon.resolveIpfsCid(pluginRepo.releases[0].metadata);
            _context14.next = 14;
            return this.ipfs.fetchString(metadataCid);
          case 14:
          ...
          case 19:
            ...
            if (_context14.t0 instanceof sdkCommon.InvalidCidError) {
          ...
          case 27:
            _context14.prev = 27;
            _metadataCid = sdkCommon.resolveIpfsCid(pluginRepo.releases[0].builds[0].metadata);
            _context14.next = 31;
          ...
          case 36:
            ...
            if (_context14.t1 instanceof sdkCommon.InvalidCidError) {
...
var ClientEncoding = /*#__PURE__*/function (_ClientCore) {
  ...
  _proto.applyInstallationAction = function applyInstallationAction(daoAddress, params) {
    if (!address.isAddress(daoAddress)) {
      throw new sdkCommon.InvalidAddressError();
    }
    var network = this.web3.getNetworkName();
    var pspInterface = osxEthers.PluginSetupProcessor__factory.createInterface();
    ...
    return [grantAction, {
      ...
      value: BigInt(0),
      data: sdkCommon.hexToBytes(hexBytes)
    }, revokeAction];
  };
  ...
  _proto.grantAction = function grantAction(daoAddress, params) {
    var where = params.where,
      who = params.who;
    if (!address.isAddress(where) || !address.isAddress(who) || !address.isAddress(daoAddress)) {
      throw new sdkCommon.InvalidAddressError();
    }
    var daoInterface = osxEthers.DAO__factory.createInterface();
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            ...
            if (address.isAddress(params.recipientAddressOrEns)) {
              _context.next = 8;
              break;
            }
            _context.next = 4;
          ...
          case 8:
            ...
            _context.next = _context.t0 === exports.TokenType.NATIVE ? 11 : _context.t0 === exports.TokenType.ERC20 ? 12 : 17;
            break;
          case 11:
            return _context.abrupt("return", {
              to: to,
          ...
          case 14:
            iface = new contracts.Contract(params.tokenAddress, erc20ContractAbi)["interface"];
            data = iface.encodeFunctionData("transfer", [params.recipientAddressOrEns, params.amount]);
            return _context.abrupt("return", {
              to: params.tokenAddress,
              value: BigInt(0),
              data: sdkCommon.hexToBytes(data)
            });
          case 17:
  ...
  function () {
    var _updateDaoMetadataAction = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(daoAddressOrEns, metadataUri) {
      var address$1, _this$web3$getSigner2, resolvedAddress, daoInterface, args, hexBytes;
      return _regeneratorRuntime().wrap(function _callee2$(_context2) {
        while (1) switch (_context2.prev = _context2.next) {
          case 0:
            address$1 = daoAddressOrEns;
            if (address.isAddress(daoAddressOrEns)) {
              _context2.next = 8;
              break;
            }
            _context2.next = 4;
          ...
          case 8:
            ...
            daoInterface = osxEthers.DAO__factory.createInterface();
            args = strings.toUtf8Bytes(metadataUri);
...
var ClientEstimation = /*#__PURE__*/function (_ClientCore) {
    ...
    var _createDao = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(params) {
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          ...
          case 3:
            daoInstance = osxEthers.DAOFactory__factory.connect(this.web3.getDaoFactoryAddress(), signer);
            pluginInstallationData = [];
            _iterator = _createForOfIteratorHelperLoose(params.plugins);
          case 6:
            if ((_step = _iterator()).done) {
  ...
  _proto.deposit = function deposit(params) {
    ...
    if (params.type !== exports.TokenType.NATIVE && params.type !== exports.TokenType.ERC20) {
      throw new sdkCommon.DepositNativeTokenError();
    }
    ...
    var daoInstance = osxEthers.DAO__factory.connect(daoAddress, signer);
    var override = {};
    if (tokenAddress === constants.AddressZero) {
      override.value = amount;
    }
    ...
    var _setAllowance = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(params) {
      ...
      return _regeneratorRuntime().wrap(function _callee2$(_context2) {
        while (1) switch (_context2.prev = _context2.next) {
          ...
          case 14:
            contract = new contracts.Contract(params.tokenAddress, erc20ContractAbi, signer);
...
var ClientDecoding = /*#__PURE__*/function (_ClientCore) {
  ...
  _proto.withdrawAction = function withdrawAction(to, value, data) {
    ...
    // ERC20 and other
    var abiObjects = [{
      tokenStandard: exports.TokenType.ERC20,
      abi: erc20ContractAbi
    }];
    for (var _i = 0, _abiObjects = abiObjects; _i < _abiObjects.length; _i++) {
      var abiObject = _abiObjects[_i];
      var hexBytes = sdkCommon.bytesToHex(data);
      var iface = new contracts.Contract(constants.AddressZero, abiObject.abi)["interface"];
  ...
  _proto.updateDaoMetadataRawAction = function updateDaoMetadataRawAction(data) {
    ...
    var result = daoInterface.decodeFunctionData(expectedFunction, hexBytes);
    var metadataUri = strings.toUtf8String(result[0]);
    sdkCommon.resolveIpfsCid(metadataUri);
    return metadataUri;
  }
  /**
    ...
    var _updateDaoMetadataAction = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(data) {
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            daoInterface = osxEthers.DAO__factory.createInterface();
            hexBytes = sdkCommon.bytesToHex(data);
            expectedFunction = daoInterface.getFunction("setMetadata");
            result = daoInterface.decodeFunctionData(expectedFunction, hexBytes);
            metadataUri = strings.toUtf8String(result[0]);
            ipfsCid = sdkCommon.resolveIpfsCid(metadataUri);
            _context.prev = 6;
            _context.next = 9;
  ...
  _proto.upgradeToAndCallAction = function upgradeToAndCallAction(data) {
    ...
    return {
      ...
      data: sdkCommon.hexToBytes(result[1])
    };
  }
  /**
  ...
  _proto.findInterface = function findInterface(data) {
    try {
      ...
      return {
        ...
        hash: sdkCommon.bytesToHex(data).substring(0, 10)
      };
    } catch (_unused2) {
      return null;
    }
...
var QueryAddresslistVotingMembers = /*#__PURE__*/graphqlRequest.gql(_templateObject$5 || (_templateObject$5 = /*#__PURE__*/_taggedTemplateLiteralLoose(["\nquery AddresslistVotingMembers($address: ID!) {\n    addresslistVotingPlugin(id: $address){\n        members {\n            address\n        }\n    }\n}\n"])));

var _templateObject$6, _templateObject2$2;
var QueryAddresslistVotingProposal = /*#__PURE__*/graphqlRequest.gql(_templateObject$6 || (_templateObject$6 = /*#__PURE__*/_taggedTemplateLiteralLoose(["\nquery AddresslistVotingProposal($proposalId: ID!) {\n  addresslistVotingProposal(id: $proposalId){\n    id\n    dao {\n      id\n      subdomain\n    }\n    creator\n    metadata\n    createdAt\n    creationBlockNumber\n    executionDate\n    executionBlockNumber\n    actions {\n      to\n      value\n      data\n    }\n    yes\n    no\n    abstain\n    votingMode\n    supportThreshold\n    startDate\n    endDate\n    executed\n    earlyExecutable\n    potentiallyExecutable\n    executionTxHash\n    voters{\n      voter{\n        address\n      }\n      voteOption\n      voteReplaced\n    }\n    totalVotingPower\n    minVotingPower\n  }\n}\n"])));
var QueryAddresslistVotingProposals = /*#__PURE__*/graphqlRequest.gql(_templateObject2$2 || (_templateObject2$2 = /*#__PURE__*/_taggedTemplateLiteralLoose(["\nquery AddresslistVotingProposals($where: AddresslistVotingProposal_filter!, $limit:Int!, $skip: Int!, $direction: OrderDirection!, $sortBy: AddresslistVotingProposal_orderBy!) {\n  addresslistVotingProposals(where: $where, first: $limit, skip: $skip, orderDirection: $direction, orderBy: $sortBy){\n    id\n    dao {\n      id\n      subdomain\n    }\n    creator\n    metadata\n    yes\n    no\n    abstain\n    startDate\n    endDate\n    executed\n    earlyExecutable\n    potentiallyExecutable\n    voters{\n      voter{\n        address\n      }\n      voteOption\n      voteReplaced\n    }\n  }\n}\n"])));

var _templateObject$7;
var QueryAddresslistVotingSettings = /*#__PURE__*/graphqlRequest.gql(_templateObject$7 || (_templateObject$7 = /*#__PURE__*/_taggedTemplateLiteralLoose(["\nquery AddresslistVotingSettings($address: ID!) {\n  addresslistVotingPlugin(id: $address){\n    minDuration\n    minProposerVotingPower\n    minParticipation\n    supportThreshold\n    votingMode\n  }\n}\n"])));
...
function toAddresslistVotingProposal(proposal, metadata) {
  ...
  return {
    id: sdkCommon.getCompactProposalId(proposal.id),
    dao: {
    ...
    actions: proposal.actions.map(function (action) {
      return {
        data: sdkCommon.hexToBytes(action.data),
        to: action.to,
    ...
    settings: {
      supportThreshold: sdkCommon.decodeRatio(BigInt(proposal.supportThreshold), 6),
      minParticipation: sdkCommon.decodeRatio(BigInt(proposal.minVotingPower) * BigInt(1000000) / BigInt(proposal.totalVotingPower), 6),
...
var AddresslistVotingClientEncoding = /*#__PURE__*/function (_ClientCore) {
  ...
  AddresslistVotingClientEncoding.getPluginInstallItem = function getPluginInstallItem(params, network) {
    var networkName = providers.getNetwork(network).name;
    if (!SupportedNetworksArray.includes(networkName)) {
      throw new sdkCommon.UnsupportedNetworkError(networkName);
    }
    ...
    var hexBytes = abi.defaultAbiCoder.encode(["tuple(uint8 votingMode, uint64 supportThreshold, uint64 minParticipation, uint64 minDuration, uint256 minProposerVotingPower) votingSettings", "address[] members"], [[votingMode, supportThreshold, minParticipation, minDuration, minProposerVotingPower], params.addresses]);
    return {
  ...
  _proto.updatePluginSettingsAction = function updatePluginSettingsAction(pluginAddress, params) {
    if (!address.isAddress(pluginAddress)) {
      throw new sdkCommon.InvalidAddressError();
    }
  ...
  _proto.addMembersAction = function addMembersAction(pluginAddress, members) {
    ...
    for (var _iterator = _createForOfIteratorHelperLoose(members), _step; !(_step = _iterator()).done;) {
      ...
      if (!address.isAddress(member)) {
        throw new sdkCommon.InvalidAddressError();
      }
    }
    var votingInterface = osxEthers.AddresslistVoting__factory.createInterface();
    // get hex bytes
...
var AddresslistVotingClientMethods = /*#__PURE__*/function (_ClientCore) {
    ...
    return _wrapAsyncGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            signer = _this.web3.getConnectedSigner();
            addresslistContract = osxEthers.AddresslistVoting__factory.connect(params.pluginAddress, signer);
          ...
          case 4:
            allowFailureMap = sdkCommon.boolArrayToBitmap(params.failSafeActions);
            ...
            _context.next = 9;
            return _awaitAsyncGenerator(addresslistContract.createProposal(strings.toUtf8Bytes(params.metadataUri), params.actions || [], allowFailureMap, Math.round(startTimestamp / 1000), Math.round(endTimestamp / 1000), params.creatorVote || 0, params.executeOnPass || false));
          case 9:
            tx = _context.sent;
            _context.next = 12;
            return {
              key: exports.ProposalCreationSteps.CREATING,
              txHash: tx.hash
            };
          case 12:
            _context.next = 14;
          ...
          case 14:
            receipt = _context.sent;
            addresslistContractInterface = osxEthers.AddresslistVoting__factory.createInterface();
            log = findLog(receipt, addresslistContractInterface, "ProposalCreated");
            if (log) {
              _context.next = 19;
              break;
            }
            throw new sdkCommon.ProposalCreationError();
          case 19:
          ...
          case 23:
            _context.next = 25;
            return {
              key: exports.ProposalCreationSteps.DONE,
              proposalId: sdkCommon.encodeProposalId(params.pluginAddress, Number(proposalId))
            };
          case 25:
          case "end":
            return _context.stop();
    ...
    return _wrapAsyncGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3() {
      ...
      return _regeneratorRuntime().wrap(function _callee3$(_context3) {
        while (1) switch (_context3.prev = _context3.next) {
          case 0:
            signer = _this2.web3.getConnectedSigner();
            _decodeProposalId = sdkCommon.decodeProposalId(params.proposalId), pluginAddress = _decodeProposalId.pluginAddress, id = _decodeProposalId.id;
            addresslistContract = osxEthers.AddresslistVoting__factory.connect(pluginAddress, signer);
            _context3.next = 5;
          ...
          case 5:
            ...
            _context3.next = 8;
            return {
              key: exports.VoteProposalStep.VOTING,
              txHash: tx.hash
            };
          case 8:
            _context3.next = 10;
          ...
          case 10:
            _context3.next = 12;
            return {
              key: exports.VoteProposalStep.DONE
            };
          case 12:
          case "end":
            return _context3.stop();
      ...
      return _regeneratorRuntime().wrap(function _callee4$(_context4) {
        while (1) switch (_context4.prev = _context4.next) {
          case 0:
            ...
            _decodeProposalId2 = sdkCommon.decodeProposalId(proposalId), pluginAddress = _decodeProposalId2.pluginAddress, id = _decodeProposalId2.id;
            addresslistContract = osxEthers.AddresslistVoting__factory.connect(pluginAddress, signer);
            _context4.next = 5;
          ...
          case 5:
            ...
            _context4.next = 8;
            return {
              key: exports.ExecuteProposalStep.EXECUTING,
              txHash: tx.hash
            };
          case 8:
            _context4.next = 10;
          ...
          case 10:
            _context4.next = 12;
            return {
              key: exports.ExecuteProposalStep.DONE
            };
          case 12:
          case "end":
            return _context4.stop();
      ...
      return _regeneratorRuntime().wrap(function _callee5$(_context5) {
        while (1) switch (_context5.prev = _context5.next) {
          case 0:
            ...
            pspContract = osxEthers.PluginSetupProcessor__factory.connect(LIVE_CONTRACTS[networkName].pluginSetupProcessor, signer); // connect to plugin repo
            addresslistVotingRepoContract = osxEthers.PluginRepo__factory.connect(LIVE_CONTRACTS[networkName].addresslistVotingRepo, signer); // use specified version or latest
            versionTag = params.versionTag;
          ...
          case 23:
            ...
            throw new sdkCommon.PluginInstallationPreparationError();
          case 28:
            _context5.next = 30;
            return {
    ...
    var _canVote = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee6(params) {
      ...
      return _regeneratorRuntime().wrap(function _callee6$(_context6) {
        while (1) switch (_context6.prev = _context6.next) {
          case 0:
            signer = this.web3.getConnectedSigner();
            _decodeProposalId3 = sdkCommon.decodeProposalId(params.proposalId), pluginAddress = _decodeProposalId3.pluginAddress, id = _decodeProposalId3.id;
            addresslistContract = osxEthers.AddresslistVoting__factory.connect(pluginAddress, signer);
    ...
    var _canExecute = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee7(proposalId) {
      ...
      return _regeneratorRuntime().wrap(function _callee7$(_context7) {
        while (1) switch (_context7.prev = _context7.next) {
          case 0:
            signer = this.web3.getConnectedSigner();
            _decodeProposalId4 = sdkCommon.decodeProposalId(proposalId), pluginAddress = _decodeProposalId4.pluginAddress, id = _decodeProposalId4.id;
            addresslistContract = osxEthers.AddresslistVoting__factory.connect(pluginAddress, signer);
  ...
  function () {
    var _getProposal = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee9(proposalId) {
      ...
      return _regeneratorRuntime().wrap(function _callee9$(_context9) {
        while (1) switch (_context9.prev = _context9.next) {
          case 0:
            if (sdkCommon.isProposalId(proposalId)) {
              _context9.next = 2;
              break;
            }
            throw new sdkCommon.InvalidProposalIdError();
          case 2:
            extendedProposalId = sdkCommon.getExtendedProposalId(proposalId);
          ...
          case 16:
            _context9.prev = 16;
            metadataCid = sdkCommon.resolveIpfsCid(addresslistVotingProposal.metadata);
            _context9.next = 20;
            return this.ipfs.fetchString(metadataCid);
          case 20:
          ...
          case 25:
            ...
            if (!(_context9.t0 instanceof sdkCommon.InvalidCidError)) {
              _context9.next = 29;
              break;
            }
  ...
  function () {
    var _getProposals = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee11(_ref) {
      var _this5 = this;
      var daoAddressOrEns, _ref$limit, limit, status, _ref$skip, skip, _ref$direction, direction, _ref$sortBy, sortBy, where, address$1, provider, resolvedAddress, query, params, name, _yield$this$graphql$r3, addresslistVotingProposals;
      return _regeneratorRuntime().wrap(function _callee11$(_context11) {
        while (1) switch (_context11.prev = _context11.next) {
          case 0:
              ...
              var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee10(proposal) {
                ...
                return _regeneratorRuntime().wrap(function _callee10$(_context10) {
                  while (1) switch (_context10.prev = _context10.next) {
                    ...
                    case 2:
                      _context10.prev = 2;
                      metadataCid = sdkCommon.resolveIpfsCid(proposal.metadata);
                      _context10.next = 6;
                      return _this5.ipfs.fetchString(metadataCid);
                    case 6:
                    ...
                    case 11:
                      ...
                      if (!(_context10.t0 instanceof sdkCommon.InvalidCidError)) {
                        _context10.next = 15;
                        break;
                      }
        ...
        while (1) switch (_context12.prev = _context12.next) {
          ...
          case 11:
            return _context12.abrupt("return", {
              ...
              supportThreshold: sdkCommon.decodeRatio(BigInt(addresslistVotingPlugin.supportThreshold), 6),
              minParticipation: sdkCommon.decodeRatio(BigInt(addresslistVotingPlugin.minParticipation), 6),
...
var AVAILABLE_FUNCTION_SIGNATURES$1 = [/*#__PURE__*/osxEthers.MajorityVotingBase__factory.createInterface().getFunction("updateVotingSettings").format("minimal"), /*#__PURE__*/osxEthers.AddresslistVoting__factory.createInterface().getFunction("addAddresses").format("minimal"), /*#__PURE__*/osxEthers.AddresslistVoting__factory.createInterface().getFunction("removeAddresses").format("minimal")];
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          ...
          case 4:
            ...
            endTimestamp = ((_params$endDate = params.endDate) == null ? void 0 : _params$endDate.getTime()) || 0;
            _context.next = 9;
            return addresslistContract.estimateGas.createProposal(strings.toUtf8Bytes(params.metadataUri), params.actions || [], allowFailureMap, Math.round(startTimestamp / 1000), Math.round(endTimestamp / 1000), params.creatorVote || 0, params.executeOnPass || false);
          case 9:
...
})(exports.WrapTokensStep || (exports.WrapTokensStep = {}));
(function (UnwrapTokensStep) {
  UnwrapTokensStep["UNWRAPPING"] = "unwrapping";
  UnwrapTokensStep["DONE"] = "done";
})(exports.UnwrapTokensStep || (exports.UnwrapTokensStep = {}));
...
var QueryTokenVotingProposal = /*#__PURE__*/graphqlRequest.gql(_templateObject$8 || (_templateObject$8 = /*#__PURE__*/_taggedTemplateLiteralLoose(["\nquery TokenVotingProposal($proposalId: ID!) {\n  tokenVotingProposal(id: $proposalId){\n    id\n    dao {\n      id\n      subdomain\n    }\n    creator\n    metadata\n    createdAt\n    creationBlockNumber\n    executionDate\n    executionBlockNumber\n    actions {\n      to\n      value\n      data\n    }\n    yes,\n    no,\n    abstain\n    votingMode\n    supportThreshold\n    startDate\n    endDate\n    executed\n    earlyExecutable\n    potentiallyExecutable\n    executionTxHash\n    voters{\n      voter{\n        address\n      }\n      voteReplaced\n      voteOption\n      votingPower\n    }\n    plugin {\n      token {\n        id\n        name\n        symbol\n        __typename\n        ...on ERC20Contract {\n          decimals\n        }\n      }\n    }\n    totalVotingPower\n    minVotingPower\n  }\n}\n"])));
var QueryTokenVotingProposals = /*#__PURE__*/graphqlRequest.gql(_templateObject2$3 || (_templateObject2$3 = /*#__PURE__*/_taggedTemplateLiteralLoose(["\nquery TokenVotingProposals($where: TokenVotingProposal_filter!, $limit:Int!, $skip: Int!, $direction: OrderDirection!, $sortBy: TokenVotingProposal_orderBy!) {\n  tokenVotingProposals(where: $where, first: $limit, skip: $skip, orderDirection: $direction, orderBy: $sortBy){\n    id\n    dao {\n      id\n      subdomain\n    }\n    creator\n    metadata\n    yes,\n    no,\n    abstain\n    startDate\n    endDate\n    executed\n    earlyExecutable\n    potentiallyExecutable\n    votingMode\n    supportThreshold\n    minVotingPower\n    totalVotingPower\n    voters{\n      voter{\n        address\n      }\n      voteReplaced\n      voteOption\n      votingPower\n    }\n    plugin{\n      token{\n        id\n        name\n        symbol\n        __typename\n        ...on ERC20Contract {\n          decimals\n        }\n      }\n    }\n  }\n}\n"])));

var _templateObject$9;
var QueryTokenVotingSettings = /*#__PURE__*/graphqlRequest.gql(_templateObject$9 || (_templateObject$9 = /*#__PURE__*/_taggedTemplateLiteralLoose(["\nquery TokenVotingSettings($address: ID!) {\n  tokenVotingPlugin(id: $address){\n    minDuration\n    minProposerVotingPower\n    minParticipation\n    supportThreshold\n    votingMode\n  }\n}\n"])));

var _templateObject$a;
var QueryTokenVotingPlugin = /*#__PURE__*/graphqlRequest.gql(_templateObject$a || (_templateObject$a = /*#__PURE__*/_taggedTemplateLiteralLoose(["\nquery TokenVotingPlugin($address: ID!) {\n  tokenVotingPlugin(id: $address){\n    token {\n      id\n      name\n      symbol\n      __typename\n      ...on ERC20Contract {\n        decimals\n      }\n    }\n  }\n}\n"])));

var _templateObject$b;
var QueryTokenVotingMembers = /*#__PURE__*/graphqlRequest.gql(_templateObject$b || (_templateObject$b = /*#__PURE__*/_taggedTemplateLiteralLoose(["\nquery TokenVotingMembers($address: ID!) {\n    tokenVotingPlugin(id: $address){\n        members {\n            address\n            balance\n            votingPower\n            delegatee {\n                address\n            }\n            delegators {\n                address\n                balance\n            }\n        }\n    }\n}\n"])));
...
function mintTokenParamsToContract(params) {
  return [params.address, bignumber.BigNumber.from(params.amount)];
}
...
function tokenVotingInitParamsToContract(params) {
  ...
  var balances = [[], []];
  if (params.newToken) {
    token = [constants.AddressZero, params.newToken.name, params.newToken.symbol];
...
var TokenVotingClientEncoding = /*#__PURE__*/function (_ClientCore) {
  ...
  TokenVotingClientEncoding.getPluginInstallItem = function getPluginInstallItem(params, network) {
    ...
    var hexBytes = abi.defaultAbiCoder.encode(
  ...
  _proto.mintTokenAction = function mintTokenAction(minterAddress, params) {
    if (!address.isAddress(minterAddress) || !address.isAddress(params.address)) {
      throw new sdkCommon.InvalidAddressError();
    }
    var votingInterface = osxEthers.IERC20MintableUpgradeable__factory.createInterface();
...
var TokenVotingClientMethods = /*#__PURE__*/function (_ClientCore) {
    ...
    return _wrapAsyncGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            signer = _this.web3.getConnectedSigner();
            tokenVotingContract = osxEthers.TokenVoting__factory.connect(params.pluginAddress, signer);
            if (!((_params$failSafeActio = params.failSafeActions) != null && _params$failSafeActio.length && params.failSafeActions.length !== ((_params$actions = params.actions) == null ? void 0 : _params$actions.length))) {
              _context.next = 4;
              break;
            }
          ...
          case 4:
            ...
            endTimestamp = ((_params$endDate = params.endDate) == null ? void 0 : _params$endDate.getTime()) || 0;
            _context.next = 9;
            return _awaitAsyncGenerator(tokenVotingContract.createProposal(strings.toUtf8Bytes(params.metadataUri), params.actions || [], allowFailureMap, Math.round(startTimestamp / 1000), Math.round(endTimestamp / 1000), params.creatorVote || 0, params.executeOnPass || false));
          case 9:
            tx = _context.sent;
            _context.next = 12;
            return {
          ...
          case 14:
            receipt = _context.sent;
            tokenVotingContractInterface = osxEthers.TokenVoting__factory.createInterface();
      ...
      return _regeneratorRuntime().wrap(function _callee3$(_context3) {
        while (1) switch (_context3.prev = _context3.next) {
          case 0:
            signer = _this2.web3.getConnectedSigner();
            _decodeProposalId = sdkCommon.decodeProposalId(params.proposalId), pluginAddress = _decodeProposalId.pluginAddress, id = _decodeProposalId.id;
            tokenVotingContract = osxEthers.TokenVoting__factory.connect(pluginAddress, signer);
            _context3.next = 5;
      ...
      return _regeneratorRuntime().wrap(function _callee5$(_context5) {
        while (1) switch (_context5.prev = _context5.next) {
          case 0:
            ...
            networkName = _this4.web3.getNetworkName(); // connect to psp contract
            pspContract = osxEthers.PluginSetupProcessor__factory.connect(LIVE_CONTRACTS[networkName].pluginSetupProcessor, signer); // connect to plugin repo
            tokenVotingRepoContract = osxEthers.PluginRepo__factory.connect(LIVE_CONTRACTS[networkName].tokenVotingRepo, signer); // use specified version or latest
            versionTag = params.versionTag;
            if (params.versionTag) {
              _context5.next = 10;
              break;
      ...
      return _regeneratorRuntime().wrap(function _callee6$(_context6) {
        while (1) switch (_context6.prev = _context6.next) {
          case 0:
            ...
            if (address.isAddress(params.wrappedTokenAddress)) {
              _context6.next = 3;
              break;
            }
            throw new sdkCommon.InvalidAddressError();
          case 3:
            wrappedErc20Contract = osxEthers.GovernanceWrappedERC20__factory.connect(params.wrappedTokenAddress, signer);
            _context6.next = 6;
            return _awaitAsyncGenerator(signer.getAddress());
          case 6:
          ...
          case 9:
            ...
            _context6.next = 12;
            return {
              key: exports.WrapTokensStep.WRAPPING,
              txHash: tx.hash
            };
          case 12:
            _context6.next = 14;
          ...
          case 14:
            _context6.next = 16;
            return {
              key: exports.WrapTokensStep.DONE
            };
          case 16:
          case "end":
            return _context6.stop();
      ...
      return _regeneratorRuntime().wrap(function _callee7$(_context7) {
        while (1) switch (_context7.prev = _context7.next) {
          ...
          case 9:
            ...
            _context7.next = 12;
            return {
              key: exports.UnwrapTokensStep.UNWRAPPING,
              txHash: tx.hash
            };
          case 12:
            _context7.next = 14;
          ...
          case 14:
            _context7.next = 16;
            return {
              key: exports.UnwrapTokensStep.DONE
            };
          case 16:
          case "end":
            return _context7.stop();
      ...
      return _regeneratorRuntime().wrap(function _callee8$(_context8) {
        while (1) switch (_context8.prev = _context8.next) {
          case 0:
            ...
            governanceErc20Contract = osxEthers.GovernanceERC20__factory.connect(params.tokenAddress, signer);
            _context8.next = 4;
    ...
    var _getDelegatee = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee10(tokenAddress) {
      ...
      return _regeneratorRuntime().wrap(function _callee10$(_context10) {
        while (1) switch (_context10.prev = _context10.next) {
          case 0:
            signer = this.web3.getConnectedSigner();
            governanceErc20Contract = osxEthers.GovernanceERC20__factory.connect(tokenAddress, signer);
            _context10.next = 4;
    ...
    var _canVote = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee11(params) {
      ...
      return _regeneratorRuntime().wrap(function _callee11$(_context11) {
        while (1) switch (_context11.prev = _context11.next) {
          case 0:
            signer = this.web3.getConnectedSigner();
            if (address.isAddress(params.voterAddressOrEns)) {
              _context11.next = 3;
              break;
            }
            throw new sdkCommon.InvalidAddressError();
    ...
    var _getProposal = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee14(proposalId) {
      ...
      return _regeneratorRuntime().wrap(function _callee14$(_context14) {
        while (1) switch (_context14.prev = _context14.next) {
          ...
          case 16:
            _context14.prev = 16;
            metadataCid = sdkCommon.resolveIpfsCid(tokenVotingProposal.metadata);
            _context14.next = 20;
            return this.ipfs.fetchString(metadataCid);
          case 20:
  ...
  function () {
    var _getProposals = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee16(_ref) {
      var _this9 = this;
      var daoAddressOrEns, _ref$limit, limit, status, _ref$skip, skip, _ref$direction, direction, _ref$sortBy, sortBy, where, address$1, provider, resolvedAddress, query, params, name, _yield$this$graphql$r3, tokenVotingProposals;
      return _regeneratorRuntime().wrap(function _callee16$(_context16) {
        while (1) switch (_context16.prev = _context16.next) {
          ...
          case 19:
            ...
            throw new sdkCommon.InvalidAddressOrEnsError(_context16.t0);
          case 22:
            where = {
              dao: address$1.toLowerCase()
            };
                ...
                return _regeneratorRuntime().wrap(function _callee15$(_context15) {
                  while (1) switch (_context15.prev = _context15.next) {
                    ...
                    case 11:
                      ...
                      if (!(_context15.t0 instanceof sdkCommon.InvalidCidError)) {
                        _context15.next = 15;
                        break;
                      }
        ...
        while (1) switch (_context17.prev = _context17.next) {
          ...
          case 11:
            return _context17.abrupt("return", {
              ...
              supportThreshold: sdkCommon.decodeRatio(BigInt(tokenVotingPlugin.supportThreshold), 6),
              minParticipation: sdkCommon.decodeRatio(BigInt(tokenVotingPlugin.minParticipation), 6),
...
var AVAILABLE_FUNCTION_SIGNATURES$2 = [/*#__PURE__*/osxEthers.MajorityVotingBase__factory.createInterface().getFunction("updateVotingSettings").format("minimal"), /*#__PURE__*/osxEthers.IERC20MintableUpgradeable__factory.createInterface().getFunction("mint").format("minimal")];
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          ...
          case 4:
            ...
            endTimestamp = ((_params$endDate = params.endDate) == null ? void 0 : _params$endDate.getTime()) || 0;
            _context.next = 9;
            return tokenVotingContract.estimateGas.createProposal(strings.toUtf8Bytes(params.metadataUri), params.actions || [], allowFailureMap, Math.round(startTimestamp / 1000), Math.round(endTimestamp / 1000), params.creatorVote || 0, params.executeOnPass || false);
          case 9:
            estimatedGasFee = _context.sent;
            return _context.abrupt("return", this.web3.getApproximateGasFee(estimatedGasFee.toBigInt()));
          case 11:
...
})(exports.ApproveProposalStep || (exports.ApproveProposalStep = {}));

var _templateObject$c, _templateObject2$4;
var QueryMultisigProposal = /*#__PURE__*/graphqlRequest.gql(_templateObject$c || (_templateObject$c = /*#__PURE__*/_taggedTemplateLiteralLoose(["\nquery MultisigProposal($proposalId: ID!) {\n  multisigProposal(id: $proposalId){\n    id\n    dao {\n      id\n      subdomain\n    }\n    creator\n    metadata\n    createdAt\n    startDate\n    endDate\n    actions {\n      to\n      value\n      data\n    }\n    executionDate\n    executionBlockNumber\n    creationBlockNumber\n    plugin {\n      onlyListed\n    }\n    minApprovals\n    executionTxHash\n    executed\n    potentiallyExecutable\n    approvers{\n      id\n    }\n  }\n}\n"])));
var QueryMultisigProposals = /*#__PURE__*/graphqlRequest.gql(_templateObject2$4 || (_templateObject2$4 = /*#__PURE__*/_taggedTemplateLiteralLoose(["\nquery MultisigProposals($where: MultisigProposal_filter!, $limit:Int!, $skip: Int!, $direction: OrderDirection!, $sortBy: MultisigProposal_orderBy!) {\n  multisigProposals(where: $where, first: $limit, skip: $skip, orderDirection: $direction, orderBy: $sortBy){\n    id\n    dao {\n      id\n      subdomain\n    }\n    creator\n    metadata\n    executed\n    potentiallyExecutable\n    approvals\n    startDate\n    endDate\n    executionDate\n    executionBlockNumber\n    creationBlockNumber\n    approvers {\n      id\n    }\n    minApprovals\n    plugin{\n      onlyListed\n    }\n  }\n}\n"])));

var _templateObject$d;
var QueryMultisigVotingSettings = /*#__PURE__*/graphqlRequest.gql(_templateObject$d || (_templateObject$d = /*#__PURE__*/_taggedTemplateLiteralLoose(["\nquery MultisigVotingSettings($address: ID!) {\n    multisigPlugin(id: $address){\n        minApprovals\n        onlyListed\n    }\n}\n"])));

var _templateObject$e;
var QueryMultisigMembers = /*#__PURE__*/graphqlRequest.gql(_templateObject$e || (_templateObject$e = /*#__PURE__*/_taggedTemplateLiteralLoose(["\nquery MultisigMembers($address: ID!) {\n    multisigPlugin(id: $address){\n        members {\n            address\n        }\n    }\n}\n"])));
...
var MultisigClientEncoding = /*#__PURE__*/function (_ClientCore) {
  ...
  _proto.addAddressesAction = function addAddressesAction(params) {
    if (!address.isAddress(params.pluginAddress)) {
      throw new sdkCommon.InvalidAddressError();
    }
    // TODO yup validation
    ...
    var multisigInterface = osxEthers.Multisig__factory.createInterface();
    // get hex bytes
...
var MultisigClientMethods = /*#__PURE__*/function (_ClientCore) {
    ...
    return _wrapAsyncGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            signer = _this.web3.getConnectedSigner();
            multisigContract = osxEthers.Multisig__factory.connect(params.pluginAddress, signer);
            if (!((_params$failSafeActio = params.failSafeActions) != null && _params$failSafeActio.length && params.failSafeActions.length !== ((_params$actions = params.actions) == null ? void 0 : _params$actions.length))) {
              _context.next = 4;
              break;
            }
          ...
          case 4:
            ...
            endTimestamp = ((_params$endDate = params.endDate) == null ? void 0 : _params$endDate.getTime()) || 0;
            _context.next = 9;
            return _awaitAsyncGenerator(multisigContract.createProposal(strings.toUtf8Bytes(params.metadataUri), params.actions || [], allowFailureMap, params.approve || false, params.tryExecution || false, Math.round(startTimestamp / 1000), Math.round(endTimestamp / 1000)));
          case 9:
            tx = _context.sent;
            _context.next = 12;
            return {
          ...
          case 14:
            receipt = _context.sent;
            multisigContractInterface = osxEthers.Multisig__factory.createInterface();
      ...
      return _regeneratorRuntime().wrap(function _callee3$(_context3) {
        while (1) switch (_context3.prev = _context3.next) {
          case 0:
            signer = _this2.web3.getConnectedSigner();
            _decodeProposalId = sdkCommon.decodeProposalId(params.proposalId), pluginAddress = _decodeProposalId.pluginAddress, id = _decodeProposalId.id;
            multisigContract = osxEthers.Multisig__factory.connect(pluginAddress, signer);
            _context3.next = 5;
          ...
          case 5:
            ...
            _context3.next = 8;
            return {
              key: exports.ApproveProposalStep.APPROVING,
              txHash: tx.hash
            };
          case 8:
            _context3.next = 10;
          ...
          case 10:
            _context3.next = 12;
            return {
              key: exports.ApproveProposalStep.DONE
            };
          case 12:
          case "end":
            return _context3.stop();
      ...
      return _regeneratorRuntime().wrap(function _callee5$(_context5) {
        while (1) switch (_context5.prev = _context5.next) {
          case 0:
            ...
            networkName = _this4.web3.getNetworkName(); // connect to psp contract
            pspContract = osxEthers.PluginSetupProcessor__factory.connect(LIVE_CONTRACTS[networkName].pluginSetupProcessor, signer); // connect to plugin repo
            multisigRepoContract = osxEthers.PluginRepo__factory.connect(LIVE_CONTRACTS[networkName].multisigRepo, signer); // use specified version or latest
            versionTag = params.versionTag;
            if (params.versionTag) {
              _context5.next = 10;
              break;
    ...
    var _canApprove = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee6(params) {
      ...
      return _regeneratorRuntime().wrap(function _callee6$(_context6) {
        while (1) switch (_context6.prev = _context6.next) {
          case 0:
            signer = this.web3.getConnectedSigner();
            if (address.isAddress(params.approverAddressOrEns)) {
              _context6.next = 3;
              break;
            }
            throw new sdkCommon.InvalidAddressOrEnsError();
    ...
    var _getProposal = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee10(proposalId) {
      ...
      return _regeneratorRuntime().wrap(function _callee10$(_context10) {
        while (1) switch (_context10.prev = _context10.next) {
          ...
          case 16:
            _context10.prev = 16;
            metadataCid = sdkCommon.resolveIpfsCid(multisigProposal.metadata);
            _context10.next = 20;
            return this.ipfs.fetchString(metadataCid);
          case 20:
  ...
  function () {
    var _getProposals = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee12(_ref) {
      var _this5 = this;
      var daoAddressOrEns, _ref$limit, limit, status, _ref$skip, skip, _ref$direction, direction, _ref$sortBy, sortBy, where, address$1, provider, resolvedAddress, query, params, name, _yield$this$graphql$r4, multisigProposals;
      return _regeneratorRuntime().wrap(function _callee12$(_context12) {
        while (1) switch (_context12.prev = _context12.next) {
          case 0:
            daoAddressOrEns = _ref.daoAddressOrEns, _ref$limit = _ref.limit, limit = _ref$limit === void 0 ? 10 : _ref$limit, status = _ref.status, _ref$skip = _ref.skip, skip = _ref$skip === void 0 ? 0 : _ref$skip, _ref$direction = _ref.direction, direction = _ref$direction === void 0 ? exports.SortDirection.ASC : _ref$direction, _ref$sortBy = _ref.sortBy, sortBy = _ref$sortBy === void 0 ? exports.ProposalSortBy.CREATED_AT : _ref$sortBy;
          ...
          case 19:
            ...
            throw new sdkCommon.InvalidAddressOrEnsError(_context12.t0);
          case 22:
            where = {
              dao: address$1.toLowerCase()
            };
                ...
                return _regeneratorRuntime().wrap(function _callee11$(_context11) {
                  while (1) switch (_context11.prev = _context11.next) {
                    ...
                    case 11:
                      ...
                      if (!(_context11.t0 instanceof sdkCommon.InvalidCidError)) {
                        _context11.next = 15;
                        break;
                      }
...
var AVAILABLE_FUNCTION_SIGNATURES$3 = [/*#__PURE__*/osxEthers.Multisig__factory.createInterface().getFunction("addAddresses").format("minimal"), /*#__PURE__*/osxEthers.Multisig__factory.createInterface().getFunction("removeAddresses").format("minimal"), /*#__PURE__*/osxEthers.Multisig__factory.createInterface().getFunction("updateMultisigSettings").format("minimal")];
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          ...
          case 4:
            ...
            endTimestamp = ((_params$endDate = params.endDate) == null ? void 0 : _params$endDate.getTime()) || 0;
            _context.next = 9;
            return multisigContract.estimateGas.createProposal(strings.toUtf8Bytes(params.metadataUri), params.actions || [], allowFailureMap, params.approve || false, params.tryExecution || true, Math.round(startTimestamp / 1000), Math.round(endTimestamp / 1000));
          case 9:
...
exports.AddresslistVotingClient = AddresslistVotingClient;
...
exports.LIVE_CONTRACTS = LIVE_CONTRACTS;
exports.MultisigClient = MultisigClient;
exports.PermissionIds = PermissionIds;
exports.Permissions = Permissions;
exports.SubgraphVoteValuesMap = SubgraphVoteValuesMap;
exports.SupportedNetworksArray = SupportedNetworksArray;
exports.TokenVotingClient = TokenVotingClient;
...
exports.computeProposalStatus = computeProposalStatus;
exports.computeProposalStatusFilter = computeProposalStatusFilter;
exports.decodeUpdatePluginSettingsAction = decodeUpdatePluginSettingsAction;
exports.encodeUpdateVotingSettingsAction = encodeUpdateVotingSettingsAction;
exports.findLog = findLog;
exports.getFunctionFragment = getFunctionFragment;
exports.unwrapProposalParams = unwrapProposalParams;
exports.votingModeFromContracts = votingModeFromContracts;
exports.votingModeToContracts = votingModeToContracts;
exports.votingSettingsToContract = votingSettingsToContract;
//# sourceMappingURL=sdk-client.cjs.development.js.map
